...
const host = process.env.MONGO_URI || '127.0.0.1'; 
...
const connect = () => { 
    if (process.env.NODE_ENV !== 'test'){ // Ensure that while testing, the main application does not try to connect to the db
